---
name: repomix-reference-futurehax-shared-tooling
description: Reference codebase for Futurehax Shared Tooling. Use this skill when you need to understand the structure, implementation patterns, or code details of the Futurehax Shared Tooling project.
---

# Futurehax Shared Tooling Codebase Reference

43 files | 2688 lines | 21490 tokens
